...
int likedvis (int argc, char **argv)
{
    ...
    quad_list *root = create_mesh(100, 100, yes);
...
void calcul_projection (quad_list *elem, float **m1, float **mx)
{
    ...
    float **vertex2d4 = multiply1(m1, elem->p4, 2, 1);
    ...
    sfVertexArray_getVertex(elem->strip, 4)->position.x = vertex2d1[0][0] + 400;
    sfVertexArray_getVertex(elem->strip, 4)->position.y = vertex2d1[1][0] + 300;
